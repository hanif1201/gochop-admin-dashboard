...
const AddMenuItem = () => {
  ...
  // Get restaurant ID from query parameter if available
  const queryParams = new URLSearchParams(location.search);
  const preselectedRestaurantId = queryParams.get("restaurant");
  ...
  const {
    ...
    defaultValues: {
      ...
      description: "",
      price: "",
      restaurant: preselectedRestaurantId || "",
      category: "",
      preparationTime: "",
      calories: "",
      available: true,
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response.success) {
        ...
        error(response.message || "Failed to create menu item");
      }
    } catch (err) {
